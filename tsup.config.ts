...
export default defineConfig(async () => {
  ...
  const {
    bundler: { managerEntries = [], previewEntries = [], nodeEntries = [], workers = [] },
  } = packageJson;
  ...
  */
  ...
  /* 
    workers are web worker scripts that will be used in the browser
    they need to be minified and have browser as platform
  */
  if (workers.length) {
    configs.push({
      ...commonConfig,
